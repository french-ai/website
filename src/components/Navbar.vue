<template>
    <b-navbar transparent shadow>
        <template slot="brand">
            <b-navbar-item tag="router-link" :to="{ name: 'home' }">
                <img
                    src="https://avatars3.githubusercontent.com/u/50276613"
                    alt="French AI"
                >
            </b-navbar-item>
        </template>
...
<!--
<template>
  <nav class="navbar is-fixed-top is-transparent has-border-bottom-gray-light">
